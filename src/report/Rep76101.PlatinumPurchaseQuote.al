report 76101 "Platinum Purchase Quote"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(CompanyCurrencyCode; GetReportCurrencyCode())
            {
            }
            column(VendorBusinessName; "Purchase Header"."Buy-from Vendor Name") { }
            column(ContactPerson; BuyFromContact.Name) { }
            column(ContactNumber; BuyFromContact."Phone No.") { }
            column(DocumentInfo_Lbl; DocumentInfoLbl)
            {
            }
            column(DocumentNoCaptionDynamic; DocumentNoCaptionLbl)
            {
            }
            column(DocumentDateCaptionDynamic; DocumentDateDynamicLbl)
            {
            }
            column(ReportTitleCopyDynamic; StrSubstNo(ReportTitleCopyLbl, CopyText))
            {
            }
            column(DocumentDetails_Lbl; DocumentDetailsLbl)
            {
            }
            column(DocumentSummary_Lbl; DocumentSummaryLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ReportTitleCopyText; StrSubstNo(ReportTitleCopyLbl, CopyText))
                    {
                    }
                    column(CompanyAddress0; CompanyInfo.Picture)
                    {
                    }
                    column(SigmaLogo; CompanyInfo.SigmaLogo)
                    {
                    }
                    column(WarrantyLogo; CompanyInfo.WarrantyLogo)
                    {
                    }
                    column(SocialMediaLogo; CompanyInfo.SocialMediaLogo)
                    {
                    }
                    ...
                    column(CompanyAddress4; CompanyCountryName)
                    {
                    }
                    column(CompanyAddress2; CompanyInfo."Post Code")
                    {
                    }
                    ...
                    column(CompanyLocationCode; CompanyInfo."Location Code")
                    {

                    }

                    column(OrderDeadline; OrderDeadline)
                    {

                    }
                    column(Shippingaddress; ShippingAddlbl)
                    {
                    ...
                    column(OrderNoCaption; DocumentNoCaptionLbl)
                    {
                    }
                    column(PageCaption; PageCaptionLbl)
                    {
                    }
                    column(DocumentDateCaption; DocumentDateDynamicLbl)
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(ItemNo2_Line; "Purchase Line"."No2")
                        {
                        }
            ...
            begin
                ...
                case "Document Type" of
                    "Document Type"::Quote:
                        begin
                            DocumentTitleLbl := 'Purchase Quote';
                            DocumentInfoLbl := 'Purchase Information';
                            DocumentNoCaptionLbl := 'Purchase Quote No.';
                            DocumentDateDynamicLbl := 'Quote Date';
                            ReportTitleCopyLbl := 'Quote %1';
                            DocumentDetailsLbl := 'Quote Details';
                            DocumentSummaryLbl := 'Quote Summary';
                        end;

                    "Document Type"::Order:
                        begin
                            DocumentTitleLbl := 'Purchase Order';
                            DocumentInfoLbl := 'Order Information';
                            DocumentNoCaptionLbl := 'Purchase Order No.';
                            DocumentDateDynamicLbl := 'Order Date';
                            ReportTitleCopyLbl := 'Order %1';
                            DocumentDetailsLbl := 'Order Details';
                            DocumentSummaryLbl := 'Order Summary';
                        end;

                    "Document Type"::Invoice:
                        begin
                            DocumentTitleLbl := 'Purchase Invoice';
                            DocumentInfoLbl := 'Invoice Information';
                            DocumentNoCaptionLbl := 'Purchase Invoice No.';
                            DocumentDateDynamicLbl := 'Invoice Date';
                            ReportTitleCopyLbl := 'Invoice %1';
                            DocumentDetailsLbl := 'Invoice Details';
                            DocumentSummaryLbl := 'Invoice Summary';
                        end;
                end;
    ...
    begin
        GLSetup.Get();
        PurchSetup.Get();
        CompanyInfo.SetAutoCalcFields(Picture, SigmaLogo, WarrantyLogo, SocialMediaLogo);
        CompanyInfo.Get();
...
#pragma warning restore AA0074
        ...
        OrderNoCaptionLbl: Label 'Purchase Order';
        ShippingAddlbl: Label 'Shipping Address:';
        OrderDeadline: label 'Order Deadline:';
        ...
        DocumentTitleLbl: Text[100];
        DocumentNoCaptionLbl: Text[100];
        DocumentDateDynamicLbl: Text[100];
        ReportTitleCopyLbl: Text[100];
        DocumentDetailsLbl: Text[100];
        DocumentSummaryLbl: Text[100];
        DocumentInfoLbl: Text[100];
        CountryRegion: Record "Country/Region";
        CompanyCountryName: Text[100];
    ...
    local procedure GetReportCurrencyCode(): Code[10]
    begin
        if "Purchase Header"."Currency Code" <> '' then
            exit("Purchase Header"."Currency Code");
